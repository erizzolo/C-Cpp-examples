...
{
    {
        ...
        if(DEBUG) printf("Before while: Operazioni residue = %d \n", residue);
        while(residue > 0)
        {
            ...
            if(DEBUG) printf("While: Operazioni residue = %d \n", residue);
            /// preparo l'operazione successiva
            dispari += 2;   /// equivale a "dispari = dispari + 2;"
        }
        /// fine !!!
        if(DEBUG) printf("End while: Operazioni residue = %d \n", residue);
        if(residue != 0)
        {
            /// verifica superflua
    ...
    }
    {
        ...
        if(DEBUG) printf("Before while: Operazioni necessarie = %d, effettuate = %d \n", necessarie, effettuate);
        while(effettuate < necessarie)
        {
            ...
            if(DEBUG) printf("While: Operazioni necessarie = %d, effettuate = %d \n", necessarie, effettuate);
            /// preparo l'operazione successiva
            dispari += 2;   /// equivale a "dispari = dispari + 2;"
        }
        /// fine !!!
        if(DEBUG) printf("End while: Operazioni necessarie = %d, effettuate = %d \n", necessarie, effettuate);
    ...
    }
    {
        ...
        if(DEBUG) printf("Before while: raggiunto = %d, obiettivo = %d \n", raggiunto, obiettivo);
        while(raggiunto != obiettivo)
        {
            ...
            raggiunto = dispari;
            if(DEBUG) printf("While: raggiunto = %d, obiettivo = %d \n", raggiunto, obiettivo);
            /// preparo l'operazione successiva, sposto verso l'obiettivo
            dispari += 2;   /// equivale a "dispari = dispari + 2;"
        }
        /// fine !!!
        if(DEBUG) printf("End While: raggiunto = %d, obiettivo = %d \n", raggiunto, obiettivo);
